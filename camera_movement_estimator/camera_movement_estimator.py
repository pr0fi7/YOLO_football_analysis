...
sys.path.append('../')
import os
from utils import measure_xy_distance, get_measure_distance
...
class CameraMovementEstimator:
    ...
    def get_camera_movement(self, frames, read_from_stub = False, stub_path = None):
        ...
        for frame_num in range(1, len(frames)):
            ...
            for i, (new, old) in enumerate(zip(new_features, old_features)):
                ...
                distance = get_measure_distance(new_feature_point, old_feature_point)
    ...
    def draw_camera_movement(self, frames, camera_movement_per_frame):
        ...
        for frame_num, frame in enumerate(frames):
            ...
            frame  = cv.putText(frame, f"X Movement: {x_movement:.2f}", (10, 30), cv.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 3)
            frame  = cv.putText(frame, f"Y Movement: {y_movement:.2f}", (10, 70), cv.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 3)
